...
* It’s always easier to understand the data when it’s presented in a visual way rather than trial and error to figure out what data values are working and which arent.
